...
function Trailer() {
  ...
  return (
      ...
      <div className='flex flex-col md:flex-row w-full  h-screen '>
        <div 
          className=' bg-contain bg-no-repeat bg-left-top w-full h-full relative hidden md:block bg-[#D45416]'
          style={{backgroundImage: `url(${process.env.PUBLIC_URL +'/images/trailer/header_bg.png'})`}}
        >
          <div className=' absolute top-16 left-1/2 -translate-x-1/2' >
            <img src={process.env.PUBLIC_URL+'/images/trailer/header_title.png'} alt="" className='w-full' data-aos="fade-down" data-aos-duration="1500" />
          </div>

        </div>
        <div 
          className=' bg-cover bg-no-repeat bg-center w-full min-h-[68vh]  aspect-[9/13] relative block md:hidden'
          style={{backgroundImage: `url(${process.env.PUBLIC_URL +'/images/trailer/header_bg_mb.png'})`}}
        >
          <div className=' absolute top-16 left-1/2 -translate-x-1/2' >
            <img src={process.env.PUBLIC_URL+'/images/trailer/header_title.png'} alt="" className='w-full' data-aos="fade-down" data-aos-duration="1500" />
          </div>
        ...
        <div 
          className=' bg-cover bg-no-repeat bg-left-top w-full md:w-2/6 p-10 border-8 border-[#D6CAAF] py-24'
          style={{backgroundImage: `url(${process.env.PUBLIC_URL +'/images/trailer/form_bg02.png'})`}}
        >
          {/* <img src={process.env.PUBLIC_URL+'/images/trailer/form_bg.png'} alt="" className=' opacity-0' /> */}
          <div className='mb-10'>
            <img src={ process.env.PUBLIC_URL+'/images/trailer/form_title.png'} alt="" data-aos="fade-down" data-aos-duration="1500"/>
          </div>
          {/* 表單 */}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full mx-auto my-5  rel" data-aos="fade-up" data-aos-duration="1500" >
              ...
              <div className='text-[#5C2C1F] font-bold text-sm w-[90%] mx-auto'>
                <div className=' flex mt-2 text-xs md:text-base items-center'>
                  ...
                  <div className='text-[#5C2C1F] ml-2   underline-offset-2 cursor-pointer' onClick={()=>setIsOpen(true)}> <span className='underline'>個人資料聲明事項</span>，我同意通過電話或郵件方式與我聯絡</div>
                </div>
              </div>
              <div className='flex w-3/4 mx-auto gap-10 my-3 md:my-12'>
                <button className='bg-[#fff] px-2 py-2  font-bold w-full  text-md tracking-wide text-[#223553]' type='submit'>送出</button>
          ...
          <div className='mt-8'>
            <img src={ process.env.PUBLIC_URL+'/images/trailer/form_subtitle.png'} alt="" className=' mx-auto 'data-aos="fade" data-aos-delay="1000"/>
            <img src={ process.env.PUBLIC_URL+'/images/trailer/form_logo.png'} alt=""  className='w-3/5 mx-auto mt-6' data-aos="fade" data-aos-delay="1500"/>
          </div>
        </div>
        {formStatus &&
       <Modal>
