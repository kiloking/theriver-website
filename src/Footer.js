...
function Footer() {
  ...
  return (
    <div className='bg-[#2E2624] pb-20'>
      
      <div className='bg-[#de641d] p-10 md:p-20 flex justify-center' >
        <img src={process.env.PUBLIC_URL+'/images/release/footer_title.png'} alt="" data-aos="fade-up" data-aos-duration="1500"/>
      </div>

      <div className='bg-[#2E2624]'>
        <div className='flex justify-center py-9 md:py-14'>
          <img src={process.env.PUBLIC_URL+'/images/release/footer_subtitle.png'} alt="" className='w-1/2 md:w-1/3' data-aos="fade-up" data-aos-duration="1500"/>
        </div>
        {/* 表單 */}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="w-full mx-auto my-5  rel" data-aos="fade-up" data-aos-duration="1500" >
            ...
            <div className='w-full  my-3 '>
              <input type="text" className="block  bg-white  w-full
                  px-3 py-2 rounded-full " placeholder="姓名"   {...register("name", { required: true})}/>
            </div>
            <div className='w-full  my-3 '>
              <input type="text" className="block  bg-white  w-full 
                  px-3 py-2  rounded-full" placeholder="聯絡電話"    {...register("tel", { required: true})}/>
            </div>
            <div className='w-full my-3  '>
              <input type="mail" className="block  bg-white   w-full
                  px-3 py-2  rounded-full" placeholder="電子信箱"   {...register("mail", { required: true})}/>
            </div>
            ...
            <div className='w-full my-3  '>
              <input type="message" className="block  bg-white   w-full
                  px-3 py-2  rounded-full" placeholder="留言訊息"   {...register("message", { required: false})}/>
            </div>
        ...
        <div className='flex justify-center py-14 '>
          <img src={process.env.PUBLIC_URL+'/images/release/footer_credit.png'} alt="" className='w-2/3 md:w-1/2 mx-auto'/>
        </div>
